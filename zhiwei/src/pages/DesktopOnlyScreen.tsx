export const DesktopOnlyScreen = () => {
  return (
    <div className="relative flex h-screen items-center justify-center overflow-hidden bg-[var(--bg-0)] px-6 text-white">
      ...
      <div className="w-full max-w-2xl rounded-3xl border border-white/10 bg-[var(--bg-1)]/95 p-10 shadow-[0_36px_100px_rgba(0,0,0,0.52)] backdrop-blur-md">
        <div className="text-xs uppercase tracking-[0.34em] text-[var(--accent)]">zhiwei desktop only</div>
        <h1 className="mt-3 text-3xl font-semibold text-white">请通过桌面客户端启动“知微”</h1>
        <p className="mt-4 text-sm leading-7 text-slate-300">
          当前页面为开发预览入口。根据产品定义，知微应以独立桌面窗口运行，不提供网页端交互。
        </p>
        <div className="mt-6 rounded-2xl border border-white/10 bg-[var(--bg-2)]/85 p-5 text-sm text-slate-300">
